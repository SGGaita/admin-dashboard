...
export const JCOpenDataTable = ({ title, subtitle }) => {
  ...
  const jobcardColumns = [
    { field: "job_card_id", headerName: "Job Card ID", flex: 1 },
    {
      field: "machine_photo",
      headerName: "Image",
      flex: 1,
    ...
    },
    {
      ...
      renderCell: (params) => {
        const statusColorMap = {
          ...
          "In Progress": '#388e3c',
          Outsourced: '#fbc02d',
          ReadyForCollection: '#f57c00',
          Collected: '#689f38'
        };

        const statusColor = statusColorMap[params.row.status_name] || 'gray'; // Default to gray if status not found
          ...
          <div>
            ...
            >
              ...
              <MenuItem
                ...
                onClick={() => { handleClose(); handleEdit(jobCardId) }}>Edit</MenuItem>
              <MenuItem
                sx={{ backgroundColor: colors.primary[400] }}
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const desiredIds = [1, 2, 3]; // Specify the desired IDs
